...
describe("Backup API Route", () => {
  ...
  it("should handle GET request to list backups", async () => {
    ...
    (listBackups as jest.MockedFunction<typeof listBackups>).mockResolvedValue(
      mockBackups,
    );
  ...
  it("should handle POST request to create backup", async () => {
    ...
    (
      createBackup as jest.MockedFunction<typeof createBackup>
  ...
  it("should handle PUT request to restore backup", async () => {
    ...
    (
      restoreBackup as jest.MockedFunction<typeof restoreBackup>
    ).mockResolvedValue(mockRestore);
