...
export const GET = withSecurity(
  async (req: NextRequest) => {
    try {
      ...
      const messages = await slackManager.getMessages(workspaceId, channelId, limit);
...
export const POST = withSecurity(
  async (req: NextRequest) => {
    try {
      ...
      const messageId = await slackManager.sendMessage(workspaceId, channelId, text, threadTs);
