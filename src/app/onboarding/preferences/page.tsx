...
import { Mail, Clock, Star, Zap, Calendar } from "lucide-react";
        ...
        >
          <Card className="p-6">
            ...
            <Typography variant="body" className="text-gray-600 mb-4">
              Add contacts that should always be prioritized (boss, clients,
              family).
            </Typography>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white rounded-lg p-4 text-center">
              ...
              <Typography variant="body" className="text-sm text-gray-600">
                {preferences.emailVolume} emails/day with{" "}
                {getVolumeLabel(preferences.emailVolume)} priority
              </Typography>
            </div>
            ...
            <div className="bg-white rounded-lg p-4 text-center">
              ...
              <Typography variant="body" className="text-sm text-gray-600">
                {
                  urgencyOptions.find(
                    (o) => o.id === preferences.responseUrgency,
                  )?.label
                }{" "}
                responses
              </Typography>
