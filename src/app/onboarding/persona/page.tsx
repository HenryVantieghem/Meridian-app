  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      >
        ...
        >
          Help us personalize your experience by selecting the role that best
          describes your work.
        </Typography>
      </motion.div>
          ...
          >
            ...
            >
              <div className="flex items-start space-x-4">
                <div
                  className={`w-12 h-12 ${persona.bgColor} rounded-lg flex items-center justify-center`}
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white rounded-lg p-6 border border-gray-200">
              ...
              <Typography variant="body" className="text-sm text-gray-600">
                AI will prioritize emails based on your role and communication
                patterns.
              </Typography>
            </div>
