...
const mockEmails: EmailPreview[] = [
  ...
  {
    id: '3',
    from: 'support@meridian.ai',
    subject: 'Welcome to Meridian - Getting Started',
    preview: 'Welcome to Meridian! We\'re excited to help you transform your email workflow...',
    priority: 'low',
    sentiment: 'positive',
    urgency: 'low',
    aiSummary: 'Welcome email from Meridian. Informational only.',
    suggestedResponse: 'Thank you for the warm welcome! I\'m excited to get started with Meridian and see how it can improve my email workflow.'
  }
];
    ...
    <div className="max-w-4xl mx-auto">
      ...
      >
        ...
        <Typography variant="body" className="text-xl text-gray-600 max-w-2xl mx-auto">
          Connect your email account and watch Meridian analyze your emails in real-time.
        </Typography>
      </motion.div>
        ...
        {showEmails && (
          ...
          >
            <div className="text-center mb-8">
              ...
              <Typography variant="body" className="text-gray-600">
                Here's how Meridian prioritized your emails
              </Typography>
            </div>
        ...
        {showCelebration && (
          ...
          >
            ...
            <Typography variant="body" className="text-gray-600 mb-8 max-w-2xl mx-auto">
              Meridian is now analyzing your emails and will help you stay focused on what matters most. 
