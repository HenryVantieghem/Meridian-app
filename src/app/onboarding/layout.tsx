...
const steps = [
  { path: '/onboarding/persona', title: 'Persona', description: 'Choose your role' },
  { path: '/onboarding/preferences', title: 'Preferences', description: 'Set your priorities' },
  { path: '/onboarding/preview', title: 'Preview', description: 'See the magic' }
];
