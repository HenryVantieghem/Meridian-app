...
export const handleBounce = async (
  ...
  console.log("Bounce handling disabled - Resend removed:", {
    email,
    reason,
    type,
  });
...
export class EmailManagementService {
  ...
  async createEmailList(
    ...
    console.log("Creating email list disabled - Resend removed:", {
      name,
      description,
    });
    return {
  ...
  async addSubscriberToList(listId: string, email: string): Promise<void> {
    console.log("Adding subscriber to list disabled - Resend removed:", {
      listId,
      email,
    });
  }
  ...
  async removeSubscriberFromList(listId: string, email: string): Promise<void> {
    console.log("Removing subscriber from list disabled - Resend removed:", {
      listId,
      email,
    });
  }
  ...
  async handleUnsubscribe(email: string, reason?: string): Promise<void> {
    console.log("Unsubscribe handling disabled - Resend removed:", {
      email,
      reason,
    });
  }
...
export const getEmailStats = async (
  ...
  console.log("Getting email stats disabled - Resend removed:", {
    userId,
    timeRange,
  });
  return {
...
export const getEmailAnalytics = async (
  ...
  console.log("Getting email analytics disabled - Resend removed:", {
    userId,
    timeRange,
  });
  return {
...
export const exportEmailData = async (
  userId: string,
  format: "csv" | "json" = "json",
): Promise<string> => {
  console.log("Exporting email data disabled - Resend removed:", {
    userId,
    format,
  });
