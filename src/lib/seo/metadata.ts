...
export const pageMetadata = {
  ...
  dashboard: {
    ...
    description:
      "Your AI-powered dashboard for intelligent email management and productivity insights.",
    keywords: ["dashboard", "email management", "productivity", "AI insights"],
  },
  pricing: {
    title: "Pricing - Napoleon",
    description:
      "Choose the perfect plan for your AI-powered email management needs.",
    keywords: ["pricing", "plans", "subscription", "AI email management"],
  },
  signIn: {
    title: "Sign In - Napoleon",
    description:
      "Sign in to your Napoleon account and access your AI-powered email management dashboard.",
    keywords: ["sign in", "login", "authentication", "AI email management"],
  },
  signUp: {
    title: "Get Started - Napoleon",
    description:
      "Join Napoleon and transform your email management with AI-powered productivity tools.",
