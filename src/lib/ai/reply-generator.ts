...
export class ReplyGenerator {
  ...
  private readonly defaultTemplates: ReplyTemplate[] = [
    {
      ...
      label: "Acknowledge",
      content:
        "Thank you for your email. I have received your message and will get back to you soon.",
      tone: "formal",
    },
    {
      id: "schedule",
      ...
      content:
        "I am available to meet at your suggested time. Please confirm the details.",
      tone: "friendly",
    },
    {
      id: "decline",
  ...
  async generateReplies(
    ...
    try {
      ...
      if (replies.length === 0)
        throw new ReplyGeneratorError("No replies generated", "NO_REPLY", true);
...
${context ? "Thread Context:\n" + context + "\n\n" : ""}From: ${email.fromName} <${email.from}>\nSubject: ${email.subject}\nBody: ${email.bodyPlain}\n\nGenerate a reply in JSON format:\n{\n  "reply": "...",\n  "reasoning": "...",\n  "templateUsed": "..."\n}\nTone: ${tone}${customTone}`;
  ...
  private confidenceScore(
    ...
    if (options.tone === "formal" && /thank|regard|sincerely/i.test(reply))
      score += 0.05;
    if (options.tone === "friendly" && /happy|glad|pleased|thanks/i.test(reply))
      score += 0.05;
