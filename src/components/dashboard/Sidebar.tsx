...
export function Sidebar({
  ...
  return (
    <div
      className={`bg-white border-r border-[#F5F5F5] flex flex-col ${collapsed ? "w-16" : "w-64"}`}
    >
      {/* Header */}
      ...
      <nav className="flex-1 p-6">
            ...
            <div className="space-y-2">
              {workspaces.map((workspace) => (
                <Button
                  key={workspace.id}
                  variant={
                    selectedWorkspace === workspace.id ? "cartier" : "ghost"
                  }
                  size="sm"
                ...
                >
                  <div
                    className={`w-2 h-2 rounded-full mr-3 ${workspace.isActive ? "bg-green-500" : "bg-[#F8F6F0]"}`}
                  />
        ...
        {!collapsed && (
          <Card variant="cartier" className="mt-8">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-body-cartier text-[#4A4A4A]">
                  Gmail Integration
                </span>
                <div
                  className={`w-3 h-3 rounded-full ${syncStatus.isActive ? "bg-green-500" : "bg-red-500"}`}
              ...
              <div className="flex items-center justify-between">
                ...
                <div
                  className={`w-3 h-3 rounded-full ${workspaces.length > 0 ? "bg-green-500" : "bg-red-500"}`}
                />
              </div>
            </div>
          </Card>
      ...
      <div className="p-6 border-t border-[#F5F5F5]">
        ...
        >
          ...
          {!collapsed && (
            <span className="font-medium">Strategic Settings</span>
          )}
        </Button>
