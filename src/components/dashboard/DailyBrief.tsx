...
export default function DailyBrief({
  ...
  const [selectedCategory, setSelectedCategory] = useState<
    "all" | "strategic" | "operational" | "informational" | "urgent"
  >("all");
  ...
  const categorizeItem = (
    item: any,
  ): "strategic" | "operational" | "informational" | "urgent" => {
    const content = (item.subject || item.text || "").toLowerCase();
      ...
      <Card className="strategic-digest-card">
        ...
        <CardContent>
          ...
          <div className="flex gap-2 mb-4">
            {["all", "strategic", "urgent", "operational", "informational"].map(
              (category) => (
                <Button
                  key={category}
                  variant={
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="flex items-center gap-1">
                      <Badge
                        className={`priority-indicator ${getPriorityColor(item.priority)}`}
                      >
                        {item.priority}
                      </Badge>
                      {item.isVIP && (
