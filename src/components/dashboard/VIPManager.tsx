...
export default function VIPManager({
  ...
  const sortedContacts = [...vipContacts].sort(
          ...
          <div className="grid grid-cols-3 gap-4 mb-4">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-orange-600">
                {
                  vipContacts.filter(
                    (c) => c.importance >= 80 && c.importance < 90,
                  ).length
                }
              </div>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setFormData({
                        ...formData,
                        relationship: value as VIPContact["relationship"],
                      })
                    }
                  >
                    <SelectTrigger>
            ...
            {sortedContacts.map((contact) => (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <Badge
                    className={`${getImportanceColor(contact.importance)} flex items-center gap-1`}
                  >
        ...
        <Card>
          ...
          <CardContent>
            <Typography variant="body2" className="text-gray-600 mb-4">
              These contacts may be VIPs based on their email patterns. Review
              and add them to your VIP list.
            </Typography>
