                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      {subscriptionId && (
                        <div className="flex justify-between">
                          ...
                          <span className="font-mono text-gray-800">{subscriptionId}</span>
                        </div>
                      )}
                    </div>
                  </div>
...
export const PaymentSuccess: React.FC<Omit<PaymentStatusProps, 'status'> & {
  ...
  return (
    <PaymentStatus
      status="success"
      message={`Welcome to ${subscriptionTier || 'Meridian'}! Your subscription is now active.`}
...
export const PaymentLoading: React.FC<Omit<PaymentStatusProps, 'status'>> = (props) => {
  return (
    <PaymentStatus
      status="loading"
