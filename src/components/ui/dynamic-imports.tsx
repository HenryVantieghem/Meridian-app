...
export const ProductionDashboard = dynamic(
  () => import('@/components/dashboard/ProductionDashboard').then(mod => ({ default: mod.ProductionDashboard })),
  {
...
export const AIActionSidebar = dynamic(
  () => import('@/components/dashboard/AIActionSidebar').then(mod => ({ default: mod.AIActionSidebar })),
  {
...
export const ContextPanel = dynamic(
  () => import('@/components/dashboard/ContextPanel').then(mod => ({ default: mod.ContextPanel })),
  {
...
export const EmailList = dynamic(
  () => import('@/components/email/EmailList').then(mod => ({ default: mod.EmailList })),
  {
...
export const ReplyComposer = dynamic(
  () => import('@/components/email/ReplyComposer').then(mod => ({ default: mod.ReplyComposer })),
  {
...
export const MessageList = dynamic(
  () => import('@/components/slack/MessageList').then(mod => ({ default: mod.MessageList })),
  {
...
export const ChannelSelector = dynamic(
  () => import('@/components/slack/ChannelSelector').then(mod => ({ default: mod.ChannelSelector })),
  {
...
export const ConfidenceMeter = dynamic(
  () => import('@/components/ai/ConfidenceMeter').then(mod => ({ default: mod.ConfidenceMeter })),
  {
...
export const BillingPortal = dynamic(
  () => import('@/components/billing/BillingPortal').then(mod => ({ default: mod.BillingPortal })),
  {
...
export const PricingCard = dynamic(
  () => import('@/components/billing/PricingCard').then(mod => ({ default: mod.PricingCard })),
  {
...
export const PerformanceMonitor = dynamic(
  () => import('@/components/ui/PerformanceMonitor').then(mod => ({ default: mod.PerformanceMonitor })),
  {
...
export const Features = dynamic(
  () => import('@/components/marketing/Features').then(mod => ({ default: mod.Features })),
  {
...
export const Pricing = dynamic(
  () => import('@/components/marketing/Pricing').then(mod => ({ default: mod.Pricing })),
  {
...
export const AIHover = dynamic(
  () => import('@/components/email/AIHover').then(mod => ({ default: mod.AIHover })),
  {
    loading: () => null,
    ssr: false
  }
...
export const AINotification = dynamic(
  () => import('@/components/email/AINotification').then(mod => ({ default: mod.AINotification })),
  {
    loading: () => null,
    ssr: false
  }
...
export const SwipeToDelegate = dynamic(
  () => import('@/components/email/SwipeToDelegate').then(mod => ({ default: mod.SwipeToDelegate })),
  {
    loading: () => null,
    ssr: false
  }
