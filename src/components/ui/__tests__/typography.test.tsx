...
import { Typography, Hero, H1, H2, H3, H4, H5, H6, P, Span, BodyLarge, Small, Caption } from '../typography';
...
describe('Typography', () => {
  ...
  it('renders with custom className', () => {
    render(<Typography variant="p" className="custom-class">Test content</Typography>);
    expect(screen.getByText('Test content')).toHaveClass('custom-class');
  });

  it('renders with custom as prop', () => {
    render(<Typography variant="p" as="div">Test content</Typography>);
