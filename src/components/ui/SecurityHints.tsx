  ...
  const securityFeatures: SecurityFeature[] = [
    {
      ...
      status: biometricSupported
        ...
        : "disabled",
      action:
        biometricSupported && !biometricEnabled ? enableBiometric : undefined,
    ...
    },
    {
      ...
      description:
        "All communications are encrypted in transit and at rest using AES-256.",
    ...
    },
    {
      ...
      description:
        "Advanced session protection with automatic logout and device tracking.",
        ...
        <CardContent className="p-6">
          ...
          <div className="text-center">
            <Typography variant="body2" className="text-gray-700 mb-4">
              Napoleon AI employs enterprise-grade security measures to protect
              your strategic communications.
            </Typography>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <ul className="text-sm text-yellow-700 space-y-1">
                <li>
                  • Enable biometric authentication for fastest secure access
                </li>
                <li>
                  • Use MFA for additional protection of sensitive
                  communications
                </li>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <Typography variant="body2" className="text-blue-700">
                Napoleon AI is SOC 2 Type II certified and GDPR compliant. Your
                data is processed with the highest privacy standards and never
