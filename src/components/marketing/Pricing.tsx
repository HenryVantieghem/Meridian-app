    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {plans.map((plan, index) => (
            ...
            >
              ...
              <Card className={`p-8 h-full ${plan.popular ? 'border-primary-500 shadow-lg' : ''}`}>
        ...
        >
          ...
          <Typography variant="body" className="text-gray-600">
            Need a custom plan? <a href="/contact" className="text-primary-600 hover:text-primary-700 font-medium">Contact our sales team</a>
          </Typography>
        </motion.div>
      </div>
    </section>
