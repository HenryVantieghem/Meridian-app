...
const testimonials = [
  {
    quote: "Napoleon has transformed how I manage my inbox. The AI prioritization saves me hours every day, and the intelligent replies are spot-on.",
    author: "Sarah Chen",
  ...
  {
    quote: "As a busy executive, I need tools that work seamlessly. Napoleon's elegant design and powerful AI features have become indispensable to my workflow.",
  ...
  {
    quote: "The time I've saved using Napoleon is incredible. What used to take 2 hours now takes 15 minutes. The ROI is immediate and substantial.",
    author: "Emily Watson",
  ...
  {
    quote: "Napoleon's security features give me peace of mind while the AI capabilities make me more productive than ever. It's the perfect balance.",
    author: "David Kim",
  ...
  {
    quote: "The intelligent email analysis is game-changing. I can now focus on what matters most while Napoleon handles the routine communication tasks.",
  ...
  {
    quote: "Napoleon has become my AI strategic commander. It understands my communication style and helps me maintain professional relationships effortlessly.",
    author: "James Wilson",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <Typography variant="body" className="text-xl text-gray-600 max-w-3xl mx-auto">
            Join thousands of executives and professionals who have transformed their email workflow with Napoleon.
          </Typography>
        </motion.div>
        ...
        >
          <Typography variant="h3" className="text-2xl font-bold text-gray-900 mb-8">
