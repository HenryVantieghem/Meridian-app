...
export default function VIPSuggestions({
  onComplete,
  onBack,
}: VIPSuggestionsProps) {
    ...
    return (
      <div className="space-y-6">
        <div className="text-center">
          ...
          <Typography
            variant="h4"
            className="font-playfair font-bold text-black mb-2"
          >
            Analyzing Your Communications
          </Typography>
          <Typography variant="body1" className="text-gray-600">
            Our AI is identifying potential VIP contacts from your email
            patterns...
          </Typography>
        </div>
    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <Typography variant="body1" className="text-gray-600 mb-4">
          We've identified potential VIP contacts based on your communication
          patterns. Select the ones you'd like to prioritize.
        </Typography>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        <Badge
                          className={`${getCategoryColor(vip.category)} flex items-center gap-1`}
                        >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div
                          className={`text-sm font-medium ${getImportanceColor(vip.importance)}`}
                        >
